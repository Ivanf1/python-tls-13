...
class TlsClientFsm(FSM):
    def __init__(
        ...
        tls_table = {
            ...
            (TlsClientFsmState.WAIT_ENCRYPTED_EXTENSIONS, TlsClientFsmEvent.ENCRYPTED_EXTENSIONS_RECEIVED): (TlsClientFsmState.WAIT_CERTIFICATE, on_encrypted_extensions_received_cb),
