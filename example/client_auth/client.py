...
certificate_path = path.join(path.dirname(__file__), "..", "..", "test", "data", "client_cert.der")
certificate_private_key_path = path.join(path.dirname(__file__), "..", "..", "test", "data", "client_key.pem")
